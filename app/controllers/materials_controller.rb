class MaterialsController < ApplicationController
  ...
  def new
    ...
    respond_to do |format|
      format.html { redirect_to [@costbook, @material], notice: 'Material was successfully created.' }
      format.json { render json: @material }
    end
  end
  ...
  private
    ...
    def find_costbook
      @costbook = Costbook.find(params[:costbook_id])
    end
end
